                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <form action="/board/modify" method="post">
                        	...
                        	<input type="hidden" value="${board.bno}" name="bno" >		<!-- 글 번호 -->
	                        ...
	                        <label>내용 </label>
	                        <textarea class="form-control"  type="text" name="content" rows="10">${board.content}</textarea>     
	                       	<br><br>
	                        
	                        
	                        <label>작성자</label>
	                        <input class="form-control"  type="text" name="writer" value="${board.writer}"><br><br><br>
